...
public class Ad implements java.io.Serializable {
	...
	public Ad(Integer id, Integer positionId, Integer advertiserId, String adTitle,
			String adDescription, String adContent, String adTargetUrl, String onlineStatus,
			Date gmtStart, Date gmtPlanEnd, String remark, String applicant, String reviewer,
			String reviewStatus, String reviewComment, String designer, String designStatus,
	...
	/**
	 * @param searchExact the searchExact to set
	 */
